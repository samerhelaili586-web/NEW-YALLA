...
export default function TachesMontage() {
  ...
  async function loadTasks() {
    ...
    try {
      ...
      // "Tâches Montage": tasks currently sitting in a montage-related status
      const montageTasks = data.filter((t) =>
        ["montage", "planification_montage"].includes(t.status_functional_type)
      );
      setTasks(montageTasks.length > 0 ? montageTasks : data);
    } catch {
      ...
      <div className="tm-page">
        <div className="tm-header">
          <div>
            ...
            <p className="tm-subtitle">File de montage en cours et à planifier.</p>
          </div>
        </div>
